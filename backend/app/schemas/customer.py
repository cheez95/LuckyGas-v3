...
class CustomerBase(BaseModel):
    ...
    cylinders_50kg: int = Field(
        0,
        alias="50公斤鋼瓶數",
        description="Number of 50kg cylinders",
        ge=0
    )
    cylinders_20kg: int = Field(
        0,
        alias="20公斤鋼瓶數",
        description="Number of 20kg cylinders",
        ge=0
    )
    cylinders_16kg: int = Field(
        0,
        alias="16公斤鋼瓶數",
        description="Number of 16kg cylinders",
        ge=0
    )
    cylinders_10kg: int = Field(
        0,
        alias="10公斤鋼瓶數",
        description="Number of 10kg cylinders",
        ge=0
    )
    cylinders_4kg: int = Field(
        0,
        alias="4公斤鋼瓶數",
        description="Number of 4kg cylinders",
        ge=0
    )
    ...
    avg_daily_usage: Optional[float] = Field(
        None,
        alias="平均日用量",
        description="Average daily gas usage (kg)",
        ge=0
    )
    ...
    is_terminated: bool = Field(
        False,
        alias="已終止",
        description="Whether customer is terminated"
    )
