...
from app.schemas.route import (
    Route, RouteCreate, RouteUpdate, RouteWithDetails,
    RouteStop, RouteStopCreate, RouteStopUpdate,
    RouteOptimizationRequest, RouteOptimizationResponse
)
from app.schemas.delivery_history import (
    DeliveryHistory, DeliveryHistoryCreate, DeliveryHistoryUpdate,
    DeliveryHistoryList, DeliveryHistoryStats
)
