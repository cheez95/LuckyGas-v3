...
class SMSTemplateBase(BaseModel):
    ...
    weight: int = Field(100, ge=0, le=100, description="Selection weight for A/B testing")
...
class ProviderConfigBase(BaseModel):
    ...
    cost_per_message: Optional[float] = Field(None, description="Base cost per message in TWD")
    cost_per_segment: Optional[float] = Field(None, description="Additional cost per segment in TWD")
...
class BulkSMSRecipient(BaseModel):
    ...
    data: Optional[Dict[str, Any]] = Field(None, description="Template data for this recipient")
    metadata: Optional[Dict[str, Any]] = Field(None, description="Additional metadata")
...
class BulkSMSRequest(BaseModel):
    ...
    template_code: Optional[str] = Field(None, description="Template to use for all recipients")
    provider: Optional[SMSProvider] = Field(None, description="Specific provider to use")
