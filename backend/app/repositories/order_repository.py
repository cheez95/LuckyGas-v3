...
class OrderRepository(BaseRepository[Order]):
    ...
    async def get_order_statistics(
        ...
        # Total orders
        total_query = select(func.count()).select_from(Order).where(and_(*base_conditions))
        ...
        return {
            ...
            "delivery_rate": status_counts.get("delivered", 0) / total_orders if total_orders > 0 else 0
        }
