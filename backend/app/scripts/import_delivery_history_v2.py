...
PRODUCT_MAPPING = {
    # Cylinder products
    '50公斤': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 50, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'qty_50kg'},
    '丙烷20': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 20, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'qty_ying20'},
    '丙烷16': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 16, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'qty_ying16'},
    '20公斤': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 20, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'qty_20kg'},
    '16公斤': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 16, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'qty_16kg'},
    '10公斤': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 10, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'qty_10kg'},
    '4公斤': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 4, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'qty_4kg'},
    '好運桶16': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 16, 'attribute': ProductAttribute.HAOYUN, 'legacy_code': 'qty_haoyun16'},
    '瓶安桶10': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 10, 'attribute': ProductAttribute.PINGAN, 'legacy_code': 'qty_pingantong10'},
    '幸福丸4': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 4, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'qty_xingfuwan4'},
    '好運桶20': {'delivery_method': DeliveryMethod.CYLINDER, 'size_kg': 20, 'attribute': ProductAttribute.HAOYUN, 'legacy_code': 'qty_haoyun20'},
    
    # Flow products
    '流量50公斤': {'delivery_method': DeliveryMethod.FLOW, 'size_kg': 50, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'flow_50kg'},
    '流量20公斤': {'delivery_method': DeliveryMethod.FLOW, 'size_kg': 20, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'flow_20kg'},
    '流量16公斤': {'delivery_method': DeliveryMethod.FLOW, 'size_kg': 16, 'attribute': ProductAttribute.REGULAR, 'legacy_code': 'flow_16kg'},
    '流量好運20公斤': {'delivery_method': DeliveryMethod.FLOW, 'size_kg': 20, 'attribute': ProductAttribute.HAOYUN, 'legacy_code': 'flow_haoyun20kg'},
    '流量好運16公斤': {'delivery_method': DeliveryMethod.FLOW, 'size_kg': 16, 'attribute': ProductAttribute.HAOYUN, 'legacy_code': 'flow_haoyun16kg'},
}
                ...
                for col_name, attrs in PRODUCT_MAPPING.items():
                    ...
                    if value and value > 0:
                        ...
                        item = DeliveryHistoryItem(
                            ...
                            quantity=int(value) if attrs['delivery_method'] == DeliveryMethod.CYLINDER else 1,
                            unit_price=product.unit_price,  # Use current price, could be improved
                            is_flow_delivery=(attrs['delivery_method'] == DeliveryMethod.FLOW),
                            flow_quantity=float(value) if attrs['delivery_method'] == DeliveryMethod.FLOW else None,
