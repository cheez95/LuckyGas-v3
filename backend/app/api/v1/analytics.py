        ...
        return {
            ...
            "changes": {
                "routes_change": calculate_change(
                    today_analytics.total_routes,
                    yesterday_analytics.total_routes
                ),
            ...
            "highlights": {
                "best_driver": today_analytics.top_performing_drivers[0] if today_analytics.top_performing_drivers else None,
                "peak_hour": max(
                    today_analytics.deliveries_by_hour.items(),
                    key=lambda x: x[1],
                    default=(None, 0)
                )[0] if today_analytics.deliveries_by_hour else None,
    ...
    try:
        ...
        while current <= end_date:
            ...
            daily_data.append({
                ...
                "distance_saved": daily_analytics.total_distance_km * 0.2  # Estimate 20% savings
            })
