...
async def get_accounts_receivable_report(
    ...
    report = await service.get_accounts_receivable_report(
        as_of_date=as_of_date, customer_id=customer_id
    )
...
async def get_cash_flow_report(
    ...
    service = FinancialReportService(db)
    report = await service.get_cash_flow_report(date_from=date_from, date_to=date_to)
...
async def get_sales_analysis(
    ...
    service = FinancialReportService(db)
    analysis = await service.get_sales_analysis(period=period, group_by=group_by)
