...
async def get_delivery_stats(
    ...
    for record in records:
        ...
        customer_counts[record.customer_code]["total_weight"] += record.total_weight_kg or 0
        customer_counts[record.customer_code]["total_cylinders"] += record.total_cylinders or 0
...
async def get_delivery(
    ...
    stmt = select(DeliveryHistoryModel).options(
        joinedload(DeliveryHistoryModel.customer)
