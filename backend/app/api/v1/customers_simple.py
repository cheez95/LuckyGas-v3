...
from app.models.essential import Customer, Order, Delivery, CustomerType
from app.schemas.customer_simple import (
    CustomerCreate, CustomerUpdate, CustomerResponse,
    CustomerDeliveryHistory
)
from app.api.deps_simple import get_current_user, require_role
from app.core.cache_simple import cache_result
