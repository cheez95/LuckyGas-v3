...
from app.models.essential import User, UserRole
from app.schemas.auth_simple import Token, TokenData, UserLogin, UserResponse
from app.core.config_simple import settings
from app.core.cache_simple import auth_cache, cache_result
