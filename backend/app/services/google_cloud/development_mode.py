...
class DevelopmentModeManager:
        ...
        try:
            if self.mode == DevelopmentMode.PRODUCTION:
                ...
                try:
                    ...
                    logger.warning(
                        f"Failed to initialize production routes service: {e}"
                    )
        ...
        try:
            if self.mode == DevelopmentMode.PRODUCTION:
                ...
                try:
                    ...
                    logger.warning(
                        f"Failed to initialize production Vertex AI service: {e}"
                    )
    ...
    def get_service_info(self) -> Dict[str, Any]:
        ...
        if (
            ...
            and self.mode != DevelopmentMode.DEVELOPMENT
        ):
            info["warnings"].append(
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        health = {"mode": self.mode.value, "healthy": True, "services": {}}
        ...
        try:
            ...
            health["services"]["routes"] = {"status": "unhealthy", "error": str(e)}
        ...
        try:
            ...
            health["healthy"] = False
            health["services"]["vertex_ai"] = {"status": "unhealthy", "error": str(e)}
