...
class IntelligentCache:
    ...
    async def set(self, api_type: str, params: Dict[str, Any], 
                  response: Any, force_ttl: Optional[int] = None) -> bool:
        ...
        try:
            ...
            logger.debug(f"Cached {api_type} response, TTL: {ttl}s, Size: {response_size}")
            return True
    ...
    async def cleanup_expired(self):
        ...
        logger.info(f"Cleaned up access patterns, {len(self.access_patterns)} active keys")
