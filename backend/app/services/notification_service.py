...
class NotificationService:
    ...
    async def send_notification(
        ...
        try:
            if channel == NotificationChannel.SMS:
                ...
                return await self._send_push_notification(recipient, notification_type, data)
            elif channel == NotificationChannel.IN_APP:
                return await self._send_in_app_notification(recipient, notification_type, data)
            else:
            ...
            if not use_queue:
                return await self.send_notification(
                    recipient, notification_type, channel, data,
                    priority=priority, use_queue=True
                )
    ...
    async def _send_email(self, email_address: str, notification_type: str, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.warning(f"Email template not found for {notification_type}, using default")
        ...
        result = await loop.run_in_executor(None, self._send_email_sync, msg, email_address)
    ...
    async def _send_push_notification(self, user_id: str, notification_type: str, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _send_in_app_notification(self, user_id: str, notification_type: str, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def send_driver_notification(self, driver_id: str, notification_type: str, data: Dict[str, Any]):
