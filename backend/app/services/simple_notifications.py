...
class SimpleNotificationService:
    ...
    def __init__(self):
        self.sms_provider_url = getattr(settings, 'SMS_PROVIDER_URL', 'https://api.sms.tw/send')
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                if success:
                    ...
                    logger.error(f"SMS failed to {normalized_phone}: {response.status_code}")
    ...
    async def get_notification_stats(self, days: int = 7) -> Dict[str, Any]:
        ...
        try:
            async for db in get_db():
                ...
                stats = {"sms": {"sent": 0, "failed": 0}, "email": {"sent": 0, "failed": 0}}
