...
class GoogleCloudConfig:
    ...
    async def get_maps_api_key(self) -> str:
        ...
        if self._maps_api_key is None:
            try:
                ...
                self._maps_api_key = await api_key_manager.get_key("GOOGLE_MAPS_API_KEY")
                if not self._maps_api_key:
                    ...
                    if self._maps_api_key:
                        ...
                        await api_key_manager.set_key("GOOGLE_MAPS_API_KEY", self._maps_api_key)
    ...
    def maps_api_key(self) -> str:
        ...
        logger.warning("Direct access to maps_api_key is deprecated. Use await get_maps_api_key() instead")
    ...
    def is_configured(self) -> bool:
        ...
        return bool(self.project_id and (self._maps_api_key or settings.GOOGLE_MAPS_API_KEY))
