...
from sqlalchemy import Column, String, Integer, Boolean, DateTime, Text, Float, JSON, Enum, Index
...
class SMSTemplate(Base):
    ...
    code = Column(String(50), unique=True, nullable=False, index=True)  # order_confirmation, etc.
