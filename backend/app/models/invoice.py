...
"""
from sqlalchemy import Column, Integer, String, Float, Boolean, DateTime, Date, ForeignKey, JSON, Enum as SQLEnum, Index
...
class Invoice(Base):
    ...
    invoice_number = Column(String(20), unique=True, nullable=False, index=True)  # 發票號碼 (e.g., AB12345678)
    ...
    payment_status = Column(SQLEnum(InvoicePaymentStatus), default=InvoicePaymentStatus.PENDING, nullable=False)
...
class CreditNote(Base):
    ...
    original_invoice_id = Column(Integer, ForeignKey("invoices.id"), nullable=False, index=True)
