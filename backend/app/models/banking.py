...
class PaymentBatch(Base):
    ...
    # Status tracking
    status = Column(SQLEnum(PaymentBatchStatus), default=PaymentBatchStatus.DRAFT, nullable=False, index=True)
...
class ReconciliationLog(Base):
    ...
    # Status
    status = Column(SQLEnum(ReconciliationStatus), default=ReconciliationStatus.PENDING, nullable=False, index=True)
