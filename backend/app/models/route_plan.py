...
class RoutePlan(Base):
    ...
    stops = relationship("RoutePlanStop", back_populates="route_plan", cascade="all, delete-orphan")
...
class RoutePlanStop(Base):
    ...
    __table_args__ = (
        UniqueConstraint("route_plan_id", "stop_sequence", name="uq_route_plan_stop_sequence"),
