...
class TestGCPSecretManager:
    ...
    def mock_secret_client(self):
        ...
        with patch("app.core.api_key_manager.secretmanager.SecretManagerServiceClient") as mock:
            yield mock
    ...
    async def test_get_gcp_manager_when_configured(self):
        ...
        with patch.dict(os.environ, {"ENVIRONMENT": "production"}):
            with patch("app.core.config.settings", mock_settings):
                with patch("app.core.api_key_manager.secretmanager.SecretManagerServiceClient"):
                    manager = await get_api_key_manager()
