...
class TestSMSEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_send_sms_with_template(self, async_client, test_token_headers_manager):
    ...
    @pytest.mark.asyncio
    async def test_send_sms_invalid_phone(self, async_client, test_token_headers_manager):
    ...
    @pytest.mark.asyncio
    async def test_send_sms_permission_denied(self, async_client, test_token_headers_driver):
    ...
    async def test_get_sms_status(self, async_client, test_token_headers_manager):
        ...
        with patch('app.services.sms_service.enhanced_sms_service.check_delivery_status') as mock_check:
    ...
    async def test_send_bulk_sms(self, async_client, test_token_headers_manager):
        """Test bulk SMS send"""
        with patch('app.services.sms_service.enhanced_sms_service.send_bulk_sms') as mock_bulk:
            mock_bulk.return_value = {
                "total": 3,
                "success": 2,
                "failed": 1,
                "errors": [
                    {"recipient": "0934567890", "error": "Invalid number"}
                ]
            }
...
class TestSMSTemplateEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_create_template(self, async_client, test_token_headers_manager, test_db):
    ...
    @pytest.mark.asyncio
    async def test_create_duplicate_template(self, async_client, test_token_headers_manager, test_db):
    ...
    @pytest.mark.asyncio
    async def test_list_templates(self, async_client, test_token_headers_manager, test_db):
    ...
    @pytest.mark.asyncio
    async def test_update_template(self, async_client, test_token_headers_manager, test_db):
    ...
    @pytest.mark.asyncio
    async def test_delete_template(self, async_client, test_token_headers_admin, test_db):
...
class TestProviderConfigEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_list_provider_configs(self, async_client, test_token_headers_manager, test_db):
    ...
    @pytest.mark.asyncio
    async def test_update_provider_config(self, async_client, test_token_headers_admin, test_db):
...
class TestSMSLogsEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_list_sms_logs(self, async_client, test_token_headers_manager, test_db):
    ...
    @pytest.mark.asyncio
    async def test_get_notification_stats(self, async_client, test_token_headers_manager):
