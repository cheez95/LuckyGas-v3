...
class TestEnhancedSMSService:
    ...
    async def test_send_sms_success(self, mock_db, mock_provider_config):
        ...
        # Mock provider send
        with patch.object(TwilioProvider, 'send_sms', return_value={
            "success": True,
            "message_id": "SM123456",
            "segments": 1,
            "cost": 1.5
    ...
    async def test_send_sms_retry_on_failure(self, mock_db, mock_provider_config):
        ...
        with patch.object(TwilioProvider, 'send_sms', return_value={
            ...
            with patch.object(Every8dProvider, 'send_sms', return_value={
                "success": True,
                "message_id": "BATCH123",
                "segments": 1,
                "cost": 1.5
    ...
    async def test_check_delivery_status(self, mock_db):
        ...
        with patch.object(TwilioProvider, 'check_status', return_value={
