...
class TestEInvoiceService:
    ...
    @pytest.mark.asyncio
    async def test_submit_invoice_validation_error(
        self, einvoice_service, mock_invoice
    ):
...
class TestEInvoiceServiceProduction:
    ...
    @pytest.mark.asyncio
    async def test_submit_invoice_production_success(
        self, production_service, mock_invoice
    ):
    ...
    @pytest.mark.asyncio
    async def test_submit_invoice_production_api_error(
        self, production_service, mock_invoice
    ):
    ...
    @pytest.mark.asyncio
    async def test_submit_invoice_production_network_error(
        self, production_service, mock_invoice
    ):
