        ...
        "api_tests": [
            ...
            },
            {
                ...
                "data": {
                    "origin": {
                        "location": {
                            "latLng": {"latitude": 25.0330, "longitude": 121.5654}
                        }
                    },
                    "destination": {
                        "location": {
                            "latLng": {"latitude": 25.0475, "longitude": 121.5173}
                        }
                    },
                    "travelMode": "DRIVE",
                },
...
def print_service_results(
    ...
    print(
        f"  {Colors.BOLD}Health Check:{Colors.ENDC} {status_icon} {status_color}{health_msg}{Colors.ENDC}"
    )
...
def print_summary(results: Dict[str, Tuple[bool, str, List]]):
    ...
    total_api_tests = sum(
        len(api_results) for _, (_, _, api_results) in results.items()
    )
