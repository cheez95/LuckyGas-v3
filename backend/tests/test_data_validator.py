    ...
    def test_validate_taiwan_address(self):
        ...
        invalid_cases = [
            ...
            (
                "台北市",
                [
                    "Missing 區鄉鎮 in address",
                    "Missing 路街 in address",
                    "Missing 號 in address",
                ],
            ),
            (
                "123 Main Street",
                [
                    "Missing 縣市 in address",
                    "Missing 區鄉鎮 in address",
                    "Missing 路街 in address",
                    "Missing 號 in address",
                ],
...
class TestCustomerDataValidation:
        ...
        return pd.DataFrame(
            {
                ...
                "cylinder_50kg": [
                    ...
                    2000,
                    0,
                ],  # 3rd is negative, 4th is too high
                ...
                "hour_8_9": [
                    ...
                    False,
                    False,
                ],  # 4th needs same day but no slots
    ...
    def test_customer_validation(self, sample_customer_df):
        ...
        assert (
            validated_df.iloc[2]["is_valid"] is False
        )  # Missing address and negative inventory
        ...
        assert (
            "Coordinates outside Taiwan" in validated_df.iloc[3]["validation_warnings"]
        )
        assert (
            "Unusually high cylinder_50kg"
...
class TestOrderDataValidation:
        ...
        return pd.DataFrame(
            {
                ...
                "delivered_50kg": [
                    ...
                    0,
                    5,
                ],  # 3rd is negative, 4th delivered none but status is delivered
                ...
                "returned_50kg": [
                    ...
                    0,
                    10,
                ],  # 3rd returned > delivered, 5th returned > delivered
    ...
    def test_order_validation(self, sample_order_df):
        ...
        assert (
            "Status is delivered but no items"
            in validated_df.iloc[3]["validation_warnings"]
        )
        assert (
            "Delivered but no actual_delivery_time"
            in validated_df.iloc[3]["validation_warnings"]
        )
...
class TestValidationReport:
    ...
    def test_generate_validation_report(self):
        ...
        validator.validation_stats = {
            ...
            "invalid_records": 15,
            "warnings": 25,
            "errors_by_type": {"missing_address": 5, "invalid_phone": 10},
            "warnings_by_type": {"invalid_tax_id": 15, "old_order": 10},
        }
