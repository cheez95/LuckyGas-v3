        ...
        "results": [
            {
                ...
                "geometry": {
                    ...
                    "viewport": {
                        "northeast": {"lat": base_lat + 0.01, "lng": base_lng + 0.01},
                        "southwest": {"lat": base_lat - 0.01, "lng": base_lng - 0.01},
                    },
                },
...
async def compute_routes(request: RouteRequest):
    ...
    logger.info(
        f"Route computation request from {request.origin} to {request.destination}"
    )
    ...
    route = {
        ...
        "polyline": {"encodedPolyline": "mock_polyline_" + uuid.uuid4().hex[:16]},
        "legs": [],
    }
