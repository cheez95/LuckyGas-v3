...
class RouteFactory(BaseFactory):
    ...
    async def create_with_stops(
        ...
        **kwargs
        ...
        base_time = datetime.combine(route.route_date, datetime.min.time().replace(hour=8))
    ...
    async def create_optimized_route(
        ...
        **kwargs
        ...
        sorted_orders = sorted(orders, key=lambda o: (o.delivery_latitude or 0, o.delivery_longitude or 0))
    ...
    async def create_completed_stop(
        ...
        **kwargs
        ...
        stop_data.update({
            ...
            "actual_departure": kwargs.get("estimated_arrival", datetime.now()) + timedelta(minutes=15),
            "actual_duration": 15,
