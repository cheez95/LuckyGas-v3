...
class BaseFactory:
    ...
    def random_phone() -> str:
        ...
        mobile_prefixes = ['0910', '0911', '0912', '0919', '0921', '0922', '0928', '0932', '0933', '0934', '0935', '0937', '0958', '0960', '0963', '0968', '0970', '0972', '0975', '0978', '0987', '0988']
    ...
    def random_landline() -> str:
        ...
        if area_code == '02':
            return f"{area_code}-{random.randint(2000, 9999)}-{random.randint(1000, 9999)}"
        else:
    ...
    def random_address() -> str:
        ...
        districts = {
            ...
            '新北市': ['板橋區', '三重區', '中和區', '永和區', '新莊區', '新店區', '土城區', '蘆洲區', '汐止區', '樹林區', '鶯歌區', '三峽區'],
            '桃園市': ['桃園區', '中壢區', '平鎮區', '八德區', '楊梅區', '蘆竹區', '龜山區', '龍潭區', '大溪區', '大園區', '觀音區', '新屋區'],
        ...
        road_types = ['路', '街', '大道', '巷']
        road_names = ['中山', '中正', '民生', '民權', '民族', '復興', '忠孝', '仁愛', '信義', '和平', '光復', '敦化', '建國', '承德', '重慶']
    ...
    @staticmethod
    def random_datetime(start_date: datetime = None, end_date: datetime = None) -> datetime:
