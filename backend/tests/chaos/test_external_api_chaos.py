...
class TestExternalAPIChaos:
    ...
    async def test_einvoice_api_failure(self, client: AsyncClient):
        ...
        with patch('app.services.einvoice_service.EInvoiceService.issue_invoice') as mock_einvoice:
            ...
            if response.status_code == 201:
                ...
                assert "invoice_status" in order or "invoice_queued" in order, \
                ...
                if queue_response.status_code == 200:
                    ...
                    assert order_id in queued_order_ids, \
    ...
    async def test_einvoice_api_timeout(self, client: AsyncClient):
        ...
        for scenario in timeout_scenarios:
            ...
            with patch('app.services.einvoice_service.EInvoiceService.issue_invoice', 
                ...
                if scenario["should_fail"]:
                    ...
                    assert response.status_code in [408, 504] or elapsed > scenario["timeout"], \
    ...
    async def test_banking_sftp_disconnect(self, client: AsyncClient):
        ...
        with patch('app.services.banking_service.BankingSFTPService.connect') as mock_sftp:
    ...
    async def test_banking_file_corruption(self, client: AsyncClient):
        ...
        for scenario in corrupt_scenarios:
            with patch('app.services.banking_service.BankingSFTPService.download_file') as mock_download:
    ...
    async def test_sms_gateway_timeout(self, client: AsyncClient):
        ...
        with patch('app.services.sms_service.SMSService.send_sms', side_effect=timeout_sms):
            # Send notification
            response = await client.post(
        ...
        for i in range(20):  # Typical rate limit threshold
            ...
            if response.status_code == 429:
                ...
                retry_after = response.headers.get("Retry-After") or \
                             rate_limit_response.get("retry_after")
    ...
    async def test_google_maps_api_quota_exceeded(self, client: AsyncClient):
        ...
        with patch('app.services.google_routes_service.GoogleRoutesService.optimize_route') as mock_routes:
            ...
            assert response.status_code in [200, 503, 429, 401], \
            ...
            if response.status_code in [503, 429]:
                ...
                assert "fallback_used" in result or "optimization_method" in result, \
    ...
    async def test_multiple_external_api_failures(self, client: AsyncClient):
        ...
        with patch('app.services.einvoice_service.EInvoiceService.issue_invoice') as mock_einvoice, \
             ...
             patch('app.services.google_routes_service.GoogleRoutesService.get_distance') as mock_maps:
            ...
            assert order_response.status_code in [201, 401], \
            ...
            assert customer_response.status_code in [201, 401], \
                "Core operations should work despite external API failures"
            ...
            if health_response.status_code == 200:
                ...
                if "services" in health_data:
                    ...
                    degraded_count = sum(1 for service in health_data["services"]
    ...
    async def test_fallback_mechanism_activation(self, client: AsyncClient):
        ...
        for scenario in fallback_scenarios:
            with patch(scenario["primary"]) as mock_service:
                mock_service.side_effect = Exception(f"{scenario['service']} unavailable")
                ...
                assert response.status_code not in [500, 502, 504], \
                    f"{scenario['service']} failure should trigger fallback, not error"
                
                if response.status_code in [200, 201]:
                    result = response.json()
                    # Should indicate fallback was used
                    assert scenario["fallback_indicator"] in str(result).lower() or \
