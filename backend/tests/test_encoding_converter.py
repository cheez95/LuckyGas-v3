...
class TestBig5ToUTF8Converter:
    ...
    def test_string_conversion_with_special_chars(self, converter):
        ...
        address_big5 = (
            b"\xa5x\xa5_\xa5\xab\xa4j\xa6w\xb0\xcf\xa9M\xa5\xad\xb8\xf4123\xb8\xb9"
        )
    ...
    def test_dataframe_conversion(self, converter):
        ...
        result_df = converter.convert_dataframe(
            df, columns=["customer_name", "address"]
        )
...
class TestTaiwanDataValidation:
    ...
    def test_phone_validation(self):
        ...
        assert (
            validate_taiwan_data("091 - 234 - 5678", "phone") is False
        )  # Wrong format
...
class TestSQLiteConversion:
    ...
    def sample_db(self, tmp_path):
        ...
        conn.executemany("INSERT INTO clients VALUES (?, ?, ?, ?, ?, ?)", sample_data)
        conn.commit()
        conn.close()
