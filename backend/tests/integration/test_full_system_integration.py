...
class TestFullSystemIntegration:
    ...
    async def mock_services(self):
        ...
        with (
            patch(
                "app.services.vertex_ai_service.VertexAIService",
                MockVertexAIDemandPredictionService,
            ),
            patch(
                "app.services.google_cloud.vertex_ai_service.VertexAIService",
                MockVertexAIDemandPredictionService,
            ),
            patch(
                "app.services.google_cloud.routes_service.GoogleRoutesService",
                MockGoogleRoutesService,
            ),
            patch(
                "app.services.dispatch.google_routes_service.GoogleRoutesService",
                MockGoogleRoutesService,
            ),
        ):
            yield
    ...
    async def test_complete_order_to_delivery_flow(
        ...
        authenticated_client.headers["Authorization"] = (
            f"Bearer {driver_response.json()['access_token']}"
        )
