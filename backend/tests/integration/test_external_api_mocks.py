...
class TestVertexAIMocking:
    ...
    async def test_demand_prediction_mock(self):
        ...
        mock_predictions = [
            {
                "customer_id": 1,
                "predicted_demand": {"50kg": 2.5, "20kg": 1.2, "10kg": 3.8},
                "confidence": 0.85,
                "factors": {
            ...
            {
                "customer_id": 2,
                "predicted_demand": {"50kg": 1.0, "20kg": 2.0, "10kg": 0.5},
                "confidence": 0.92,
                "factors": {
        ...
        with patch(
            "app.services.google_cloud.mock_vertex_ai_service.MockVertexAIService.predict_daily_demand"
        ) as mock_predict:
    ...
    async def test_sms_delivery_notification(self):
        ...
        with patch("aiohttp.ClientSession") as mock_session_class:
            ...
            result = await service.send_delivery_sms(
                phone="0912345678", order_number="ORD20240126001", delivery_time="14:30"
            )
