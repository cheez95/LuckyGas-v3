...
class TestFinancialIntegration:
    ...
    async def test_payment_processing_workflow(
        ...
        assert updated_customer["current_balance"] == 25000 - 2520  # Original balance - payment
    ...
    async def test_einvoice_submission(
        ...
        # Mock e-invoice API
        with patch("app.services.einvoice_service.EInvoiceService.submit_invoice") as mock_submit:
